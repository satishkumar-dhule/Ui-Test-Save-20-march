      ...
      - generic [ref=e48]:
        ...
        - tablist "Study sections" [ref=e53]:
          - tab "Q&A 2" [ref=e54] [cursor=pointer]:
            ...
            - generic [ref=e58]: Q&A
            - generic [ref=e59]: "2"
          - tab "Flashcards 5" [active] [selected] [ref=e60] [cursor=pointer]:
            - img [ref=e62]
          ...
          - navigation "Flashcard navigation" [ref=e138]:
            ...
            - generic [ref=e168]:
              ...
              - 'button "What is prototypal inheritance in JavaScript? #5" [ref=e185]':
                ...
                - generic [ref=e188]: "#5"
          - main "Flashcard content" [ref=e189]:
            - toolbar "Flashcard controls" [ref=e190]:
              ...
              - button "Previous flashcard" [disabled] [ref=e203]:
                - img [ref=e204]
            ...
            - generic [ref=e209]:
              - button "Show answer side" [ref=e211] [cursor=pointer]:
                - generic [ref=e212]:
                  ...
                  - paragraph [ref=e214]: What is hoisting in JavaScript?
                  - paragraph [ref=e215]: "Hint: Think about what happens before the code runs"
                  - paragraph
                - generic [ref=e216]:
                  - generic [ref=e217]: ANSWER
                  - generic [ref=e218]:
                    - paragraph [ref=e220]:
                      - text: Hoisting moves variable and function declarations to the top of their scope before execution.
                      - code [ref=e221]: var
                      - text: declarations are hoisted (but not initialized — undefined until assigned).
                      - code [ref=e222]: let
                      - text: /
                      - code [ref=e223]: const
                      - text: are hoisted but sit in a 'Temporal Dead Zone' until their declaration line.
                    - code [ref=e225]: "console.log(x); // undefined (hoisted var) var x = 5; console.log(y); // ReferenceError (TDZ) let y = 10; greet(); // Works! Function declarations are fully hoisted function greet() { console.log('Hello'); }"
              - generic [ref=e226]:
