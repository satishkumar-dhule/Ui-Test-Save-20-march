...
import { AppProvidersV2, useThemeV2, useNotificationV2 } from '@/providers-v2'
import { AppRouter, useActiveRoute, useBreadcrumbs, useNavigation } from '@/routes-v2'
import { useUIStore, useContentStore, useFilterStore } from '@/stores-v2'
    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-14 items-center">
        ...
        <nav className="flex items-center space-x-6 text-sm font-medium mx-6">
          ...
          <a
            href="#"
            onClick={(e) => { e.preventDefault(); navigate('/practice/exam') }}
