  ...
  return [
    ...
    },
    {
      ...
      data: {
        ...
        choices: [
          ...
          { id: 'D', text: 'ADD is deprecated, use COPY only' },
        ],
        correct: 'B',
        explanation:
          'COPY transfers files from build context to the container. ADD can do the same but also automatically extract compressed files and fetch remote URLs.',
        difficulty: 'easy',
      },
      quality_score: 0.9,
      status: 'published',
    },
    {
      ...
      data: {
        ...
        choices: [
          { id: 'A', text: 'Faster build times' },
          { id: 'B', text: 'Smaller final image size by copying only artifacts' },
          { id: 'C', text: 'Better security during build' },
          { id: 'D', text: 'Parallel build execution' },
        ],
        correct: 'B',
        explanation:
          'Multi-stage builds allow you to use a large build image for compilation, then copy only the needed artifacts to a small production image.',
        difficulty: 'medium',
      },
      quality_score: 0.88,
      status: 'published',
    ...
    },
    {
      ...
      data: {
        ...
        choices: [
          { id: 'A', text: 'A single container or multiple closely coupled containers' },
          { id: 'B', text: 'A node running kubelet' },
          { id: 'C', text: 'A ReplicaSet specification' },
          { id: 'D', text: 'A Kubernetes Service' },
        ],
        correct: 'A',
        explanation:
          'A Pod is the smallest deployable unit in Kubernetes. It represents a single instance of a running process and can contain one or more closely coupled containers that share network and storage.',
        difficulty: 'easy',
      },
      quality_score: 0.9,
      status: 'published',
    },
    {
      ...
      data: {
        ...
        domain: 'Services',
        question:
          'Which Service type provides a stable internal IP accessible only within the cluster?',
        choices: [
          { id: 'A', text: 'NodePort' },
          { id: 'B', text: 'LoadBalancer' },
          { id: 'C', text: 'ClusterIP' },
          { id: 'D', text: 'ExternalName' },
        ],
        correct: 'C',
        explanation:
          'ClusterIP is the default Service type. It creates a stable internal cluster IP that is only accessible from within the cluster, perfect for internal pod-to-pod communication.',
        difficulty: 'easy',
      },
      quality_score: 0.92,
      status: 'published',
    },
    {
      ...
      data: {
        ...
        channelId: 'kubernetes',
        domain: 'Deployments',
        question: "What happens when you update a Deployment's container image?",
        choices: [
          { id: 'A', text: 'All pods are killed immediately and recreated' },
          { id: 'B', text: 'Rolling update creates new pods while terminating old ones' },
          { id: 'C', text: 'Nothing happens until you delete the pods manually' },
          { id: 'D', text: 'The cluster is restarted entirely' },
        ],
        correct: 'B',
        explanation:
          'Deployments use a rolling update strategy by default. New ReplicaSet pods are created while old ones are terminated, ensuring zero-downtime deployments.',
        difficulty: 'medium',
      },
      quality_score: 0.91,
      status: 'published',
    },
    {
      ...
      data: {
        ...
        correct: 'B',
        explanation:
          'The kube-scheduler watches for newly created Pods and assigns them to nodes based on resource requirements, affinity rules, and other constraints.',
        difficulty: 'easy',
      },
      quality_score: 0.93,
      status: 'published',
    },
    {
      ...
      data: {
        ...
        choices: [
          { id: 'A', text: 'To manage internal pod-to-pod communication' },
          { id: 'B', text: 'To provide external HTTP/HTTPS access to Services' },
          { id: 'C', text: 'To expose pods as NodePort services' },
          { id: 'D', text: 'To create persistent volumes' },
        ],
        correct: 'B',
        explanation:
          'Ingress provides HTTP/HTTPS routing to Services based on host and path rules. It acts as a smart router or entry point for cluster traffic.',
        difficulty: 'medium',
      },
      quality_score: 0.89,
      status: 'published',
