...
const SimpleCodeEditor = React.memo(function SimpleCodeEditor({
  ...
  return (
    <div className="flex flex-1 overflow-hidden bg-[var(--dp-bg-0)]">
      {/* Line numbers */}
      <div
        className="hidden md:flex desktop-only flex-col items-end pr-3 pt-[14px] pb-[14px] select-none min-w-[48px] bg-[var(--dp-bg-0)] border-r border-border/40"
        aria-hidden="true"
      >
  ...
  if (isLoading) {
    return (
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
        {/* Sidebar skeleton */}
        <div className="hidden md:flex desktop-only md:w-[240px] flex-col border-r border-border bg-muted/30 p-4 gap-3">
        ...
        className={`
          ...
          ${
            sidebarOpen
              ...
              : 'hidden md:flex desktop-only md:w-[240px] lg:w-[260px]'
          }
        `}
      >
        {/* Sidebar header */}
        <div className="flex items-center gap-2.5 px-4 py-3 border-b border-border">
          ...
          <button
            onClick={() => setSidebarOpen(false)}
            className="flex md:hidden mobile-only items-center justify-center w-9 h-9 -mr-1 rounded-lg hover:bg-muted transition-colors cursor-pointer focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1"
      ...
      <main id="coding-content" className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <div className="flex items-center gap-2 px-3 md:px-4 py-2.5 border-b border-border bg-muted/20 flex-shrink-0 flex-wrap">
          ...
          <button
            ...
            className="flex md:hidden mobile-only items-center justify-center w-11 h-11 rounded-lg border border-border bg-background hover:bg-muted transition-colors cursor-pointer focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1"
          ...
          <div
            className="hidden md:flex mobile-only items-center gap-0.5 bg-muted/60 rounded-lg p-0.5 border border-border/50"
            role="tablist"
        ...
        <div className="flex-1 flex flex-col md:flex-row overflow-hidden min-h-0">
          ...
          <div
            className={`flex ${mobilePanel === 'code' ? 'hidden md:flex desktop-only' : ''} md:flex md:w-[42%] flex-shrink-0 flex-col border-b md:border-b-0 md:border-r border-border bg-background/50 overflow-hidden min-h-0 flex-1 md:flex-none`}
          >
          ...
          {/* ── Right: Editor ───────────────────────────────────────── */}
          <div
            className={`flex ${mobilePanel === 'problem' ? 'hidden md:flex desktop-only' : ''} md:flex flex-1 flex-col overflow-hidden min-w-0`}
          >
