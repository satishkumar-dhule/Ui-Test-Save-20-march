...
console.log("\n💡 Available commands:");
console.log("   bun run spawn-agents.ts spawn   - Spawn all agents");
console.log("   bun run spawn-agents.ts status  - Show team status");
console.log("   bun run spawn-agents.ts test    - Run E2E tests");
console.log("   bun run spawn-agents.ts process - Process work items");
console.log("   bun run spawn-agents.ts full   - Run full cycle");
